...
type SqlServerLiveRepository struct {
	getDB func(instanceName string) interface{}
}

func NewSqlServerLiveRepository(getDB func(instanceName string) interface{}) *SqlServerLiveRepository {
	return &SqlServerLiveRepository{getDB: getDB}
}
...
func (r *SqlServerLiveRepository) GetKPIs(ctx context.Context, instanceName string) QueryResult {
	query := `
		SELECT 
...
func (r *SqlServerLiveRepository) GetRunningQueries(ctx context.Context, instanceName string) QueryResult {
	query := `
		SELECT TOP 50
			r.session_id, 
			s.login_name, 
...
func (r *SqlServerLiveRepository) GetBlockingChains(ctx context.Context, instanceName string) QueryResult {
	query := `
...
func (r *SqlServerLiveRepository) GetTempDBUsage(ctx context.Context, instanceName string) QueryResult {
	query := `
		SELECT 
...
func (r *SqlServerLiveRepository) GetWaitStats(ctx context.Context, instanceName string) QueryResult {
	query := `
		SELECT TOP 10 
			wait_type, 
			waiting_tasks_count, 
...
func (r *SqlServerLiveRepository) GetConnectionsByApp(ctx context.Context, instanceName string) QueryResult {
	query := `
		SELECT 
			program_name, 
