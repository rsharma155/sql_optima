...
func (c *SqlServerRepository) FetchBestPractices(instanceName string) models.BestPracticesResult {
...
func (c *SqlServerRepository) evaluateServerRules(configs map[string]string) []models.ServerConfigCheck {
...
func (c *SqlServerRepository) calculateHealthScore(result models.GuardrailsResult) (int, string) {
	score := 100
...
func (c *SqlServerRepository) generateRiskSummary(result models.GuardrailsResult) []models.RiskSummary {
