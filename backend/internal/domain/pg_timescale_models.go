...
type PGTimescaleLock struct {
	...
	ServerInstance   string         `json:"server_instance_name" db:"server_instance_name"`
	...
	WaitDurationMs   float64        `json:"wait_duration_ms" db:"wait_duration_ms"`
}
...
type PGStatStatementsDelta struct {
	...
	WalBytes         float64   `json:"wal_bytes_delta" db:"wal_bytes_delta"`
}
