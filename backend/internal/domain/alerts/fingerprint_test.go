...
func TestFingerprint_Deterministic(t *testing.T) {
	fp1 := Fingerprint("prod-db-01", EngineSQLServer, "blocking", "sqlserver_blocking")
	fp2 := Fingerprint("prod-db-01", EngineSQLServer, "blocking", "sqlserver_blocking")
	if fp1 != fp2 {
...
func TestFingerprint_DifferentInputs(t *testing.T) {
	fp1 := Fingerprint("prod-db-01", EngineSQLServer, "blocking", "sqlserver_blocking")
	fp2 := Fingerprint("prod-db-02", EngineSQLServer, "blocking", "sqlserver_blocking")
	if fp1 == fp2 {
...
func TestFingerprint_Length(t *testing.T) {
	fp := Fingerprint("prod-db-01", EngineSQLServer, "blocking", "sqlserver_blocking")
	if len(fp) != 32 {
