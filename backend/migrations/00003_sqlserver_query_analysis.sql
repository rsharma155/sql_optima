...
--          sqlserver_watched_queries, sqlserver_watched_query_snapshots, sqlserver_watched_query_events,
--          sqlserver_query_regressions, sqlserver_plan_instability.
--
-- Author: Ravi Sharma
...
-- +goose Down
SELECT remove_retention_policy('sqlserver_plan_instability', if_exists => TRUE);
SELECT remove_compression_policy('sqlserver_plan_instability', if_exists => TRUE);
DROP TABLE IF EXISTS sqlserver_plan_instability;

SELECT remove_retention_policy('sqlserver_query_regressions', if_exists => TRUE);
SELECT remove_compression_policy('sqlserver_query_regressions', if_exists => TRUE);
DROP TABLE IF EXISTS sqlserver_query_regressions;

DROP TABLE IF EXISTS sqlserver_watched_query_events;

SELECT remove_retention_policy('sqlserver_watched_query_snapshots', if_exists => TRUE);
SELECT remove_compression_policy('sqlserver_watched_query_snapshots', if_exists => TRUE);
DROP TABLE IF EXISTS sqlserver_watched_query_snapshots;

DROP TABLE IF EXISTS sqlserver_watched_queries;
