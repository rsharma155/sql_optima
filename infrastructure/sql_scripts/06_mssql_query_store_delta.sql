...
--
-- Purpose: Pipeline for change-only Query Store snapshots and delta interval calculation.
--          Enables high-fidelity tracking of query performance shifts over time.
--
-- Author: Ravi Sharma
