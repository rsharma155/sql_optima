...
('Postgres Query Stats',             'Postgres',  900,   true, 20),
...
('pg_locks_blocking',                'Postgres',  15,    true, 10),
('sqlserver_locks_blocking',         'SQLSERVER', 15,    true, 10),
...
('SQL Server File IO Latency',       'SQLSERVER', 60,    true, 160),
('SQL Server Memory Intelligence',   'SQLSERVER', 60,    true, 170),
