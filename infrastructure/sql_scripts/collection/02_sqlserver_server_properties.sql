-- Metric: sqlserver_server_properties
...
SELECT /* SQL_OPTIMA */   
    ...
    (SELECT /* SQL_OPTIMA */   cpu_type FROM sys.dm_os_sys_info) AS cpu_type,
    ...
    CONVERT(VARCHAR(64), HASHBYTES('SHA2_256', 
        CONCAT(osi.cpu_count, osi.hyperthread_ratio, osi.socket_count, osi.cores_per_socket, 
               osi.physical_memory_kb, (SELECT /* SQL_OPTIMA */   COUNT(*) FROM sys.dm_os_nodes WHERE node_id < 64))), 2) AS properties_hash
