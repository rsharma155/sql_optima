 ...
 *
 * Purpose: Query drilldown page with top queries by CPU, reads, and duration.
 *
 * Author: Ravi Sharma
...
window.sqlserver_QueryDrilldown = async function() {
    window.scrollTo(0, 0);
    ...
    window.routerOutlet.innerHTML = `
        <div class="page-view active dashboard-sky-theme">
            <div class="page-title flex-between">
                <div>
                    <button class="btn btn-sm btn-outline mb-2" data-action="call" data-fn="appNavigate" data-arg="${window.escapeHtml(window.appState.queryDrillBackRoute || 'drilldown-top-queries')}"><i class="fa-solid fa-arrow-left"></i> Back</button>
            ...
            <div class="metric-card glass-panel mt-4" style="text-align: left; padding: 2rem;">
                <div class="card-header flex-between" style="border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 1rem;">
                    ...
                    <button class="btn btn-sm btn-outline" data-action="copy-text" data-text="${window.escapeHtml(payload.text)}"><i class="fa-solid fa-copy"></i> Copy Trace</button>
                </div>
